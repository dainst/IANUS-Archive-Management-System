...
<div class="item">
    ...
    <%
   	for(Actor actor : sessionBean.getDc().getRightsHolderList()) {
   		...
   		if(actor instanceof Person) {
   			...
   			<div class="clearfix">
		   		<%
		   		String logo = util.getDataUriImage(wfipId, filePath.replace("%actorID%", Long.toString(actor.getId())), "Logo Rechteinhaber");
