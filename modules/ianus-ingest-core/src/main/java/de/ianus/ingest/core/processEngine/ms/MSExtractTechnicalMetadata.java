...
/**
 * This class is also a good example for the use of agents and events.
 * @author hschmeer
 *
 */
public class MSExtractTechnicalMetadata  extends AbstractTask implements ActivityBehavior{

	private static final Logger logger = LogManager.getLogger(MSExtractTechnicalMetadata.class);
	...
	public void execute(ActivityExecution execution) throws Exception {
		...
		try{
			...
			transition = execution.getActivity().findOutgoingTransition("sf_extract_technical_metadata_ok");
