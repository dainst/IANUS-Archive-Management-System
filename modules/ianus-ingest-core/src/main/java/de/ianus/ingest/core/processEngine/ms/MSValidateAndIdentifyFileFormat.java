...
public class MSValidateAndIdentifyFileFormat extends AbstractTask implements ActivityBehavior{

	private static final Logger logger = LogManager.getLogger(MSValidateAndIdentifyFileFormat.class);
	...
	public void execute(ActivityExecution execution) throws Exception {
		...
		try{
			...
			transition = execution.getActivity().findOutgoingTransition("sf_validate_file_format_ok");
